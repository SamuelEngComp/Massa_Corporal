package com.example.massacorporal.util
...
class DataStoreUtil(private val context: Context) {
    ...
    fun getTheme(isSystemDarkTheme: Boolean): Flow<Boolean> = context.dataStore.data.map {
        preferences -> preferences[THEME_KEY] ?: isSystemDarkTheme
    }
